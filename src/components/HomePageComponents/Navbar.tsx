  ...
  return (
    <div className=''>
      <header className="p-4 navbarr">
        <div className="container flex justify-between h-16 mx-auto" style={{backgroundColor: "lightblue"}}>
          <div className="flex justify-between w-full">
            <Link  href="/" aria-label="Back to homepage" className="flex items-center p-2">
              <img src="/logo.webp" alt="logo" style={{width: "50px"}}/>
              <p className=' font-semibold text-3xl text-blue-600'>Commune Crytpo Tracker</p>
            </Link>
